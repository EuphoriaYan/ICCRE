...
def train(model, optimizer, train_dataloader, dev_dataloader, test_dataloader,
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if (global_step + 1) % config.checkpoint == 0:
                ...
                if config.do_eval:
                    ...
                    better_flag = False
                    if config.task_name == 'BIO_cws':
                        dev_loss, dev_acc, dev_prec, dev_rec, dev_f1 = dev_result
                        test_loss, test_acc, test_prec, test_rec, test_f1 = test_result
                        print("......" * 10)
                        ...
                        dev_loss, dev_prec, dev_rec, dev_f1 = dev_result
                        test_loss, test_prec, test_rec, test_f1 = test_result
                        print("......" * 10)
                        ...
                        loss, c_p, c_r, c_f1, n_p, n_r, n_f1 = dev_result
                        print("......" * 10)
                        print("Loss: Total")
                        print(loss)
                        print("......" * 10)
                        ...
                        if c_f1 > cws_best_f1:
                            ...
                            better_flag = True
                        if n_f1 > ner_best_f1:
                            ner_best_precision = n_p
                            ner_best_recall = n_r
                            ner_best_f1 = n_f1
                            better_flag = True
                    elif config.task_name == 'pos':
                        loss, p_p, p_r, p_f1 = dev_result
                        print("......" * 10)
                        print("Loss: Total")
                        print(loss)
                        print("......" * 10)
    ...
    if config.task_name == 'BIO_cws':
        ...
        print(ner_best_precision, ner_best_recall, ner_best_f1)
        print("=&=" * 15)
    elif config.task_name == 'pos':
        print("=&=" * 15)
        print("POS: best loss ")
